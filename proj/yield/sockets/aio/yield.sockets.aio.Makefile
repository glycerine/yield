...
O_FILE_PATHS += ../../../../build/yield/sockets/aio/nbio_queue.o ../../../../build/yield/sockets/aio/recv_aiocb.o
ifeq ($(UNAME), Darwin)
...
ifeq ($(UNAME), MINGW32)
	O_FILE_PATHS += ../../../../build/yield/sockets/aio/win32/accept_aiocb.o ../../../../build/yield/sockets/aio/win32/aio_queue.o
endif
