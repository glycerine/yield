...
../../../../build/yield/sockets/ssl_test/ssl_socket_pair.o: ../../../../test/yield/sockets/ssl/ssl_socket_pair.cpp
	-mkdir -p ../../../../build/yield/sockets/ssl_test 2>/dev/null
	$(CXX) -c -o ../../../../build/yield/sockets/ssl_test/ssl_socket_pair.o -MD $(CXXFLAGS) ../../../../test/yield/sockets/ssl/ssl_socket_pair.cpp

../../../../build/yield/sockets/ssl_test/ssl_socket_test.o: ../../../../test/yield/sockets/ssl/ssl_socket_test.cpp
	-mkdir -p ../../../../build/yield/sockets/ssl_test 2>/dev/null
	$(CXX) -c -o ../../../../build/yield/sockets/ssl_test/ssl_socket_test.o -MD $(CXXFLAGS) ../../../../test/yield/sockets/ssl/ssl_socket_test.cpp

../../../../build/yield/sockets/ssl_test/test_pem_certificate.o: ../../../../test/yield/sockets/ssl/test_pem_certificate.cpp
	-mkdir -p ../../../../build/yield/sockets/ssl_test 2>/dev/null
	$(CXX) -c -o ../../../../build/yield/sockets/ssl_test/test_pem_certificate.o -MD $(CXXFLAGS) ../../../../test/yield/sockets/ssl/test_pem_certificate.cpp

../../../../build/yield/sockets/ssl_test/test_pem_private_key.o: ../../../../test/yield/sockets/ssl/test_pem_private_key.cpp
	-mkdir -p ../../../../build/yield/sockets/ssl_test 2>/dev/null
	$(CXX) -c -o ../../../../build/yield/sockets/ssl_test/test_pem_private_key.o -MD $(CXXFLAGS) ../../../../test/yield/sockets/ssl/test_pem_private_key.cpp
