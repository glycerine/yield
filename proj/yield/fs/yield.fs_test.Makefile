...
O_FILE_PATHS += ../../../build/yield/fs/directory_test.o ../../../build/yield/fs/memory_mapped_file_test.o ../../../build/yield/fs/named_pipe_test.o ../../../build/yield/fs/path_test.o ../../../build/yield/fs/yield_fs_test_main.o
ifeq ($(UNAME), Darwin)
...
../../../build/yield/fs/memory_mapped_file_test.o: ../../../test/yield/fs/memory_mapped_file_test.cpp
	-mkdir -p ../../../build/yield/fs 2>/dev/null
	$(CXX) -c -o ../../../build/yield/fs/memory_mapped_file_test.o -MD $(CXXFLAGS) ../../../test/yield/fs/memory_mapped_file_test.cpp
