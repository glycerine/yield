...
LIBS += -lyield_getopt -lyield_common


DEP_FILE_PATHS := $(shell find ../../../build/yield/getopt_test -name "*.d")


OBJECT_FILE_PATHS += ../../../build/yield/getopt_test/yield_getopt_test_main.o


../../../bin/yield/yield_getopt_test: $(OBJECT_FILE_PATHS)
	-mkdir -p ../../../bin/yield 2>/dev/null
	$(LINK.cpp) $(OBJECT_FILE_PATHS) -o $@ $(LIBS)

clean:
	$(RM) ../../../bin/yield/yield_getopt_test $(OBJECT_FILE_PATHS)
