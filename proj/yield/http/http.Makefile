...
LIBS += -lyield_clientserver -lyield_aio -lyield_fs -lyield_i18n -lyield_poll -lyield_sockets -lyield_stage -lyield_thread -lyield_uri -lyield_common


DEP_FILE_PATHS := $(shell find ../../../build/yield/http -name "*.d")


OBJECT_FILE_PATHS += ../../../build/yield/http/access_log.o ../../../build/yield/http/file_access_log.o ../../../build/yield/http/http_client.o ../../../build/yield/http/http_message.o ../../../build/yield/http/http_message_parser.o ../../../build/yield/http/http_request.o ../../../build/yield/http/http_request_handler.o ../../../build/yield/http/http_request_parser.o ../../../build/yield/http/http_response.o ../../../build/yield/http/http_response_parser.o ../../../build/yield/http/http_server.o
